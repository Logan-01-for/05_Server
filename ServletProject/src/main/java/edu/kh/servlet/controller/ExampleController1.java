...
// "/example1" 이라는 클라이언트의 요청을 받아서 처리한 후 응답ㅇ르 해줄 
// 서블릿 클래스 ExampleController1를 만든다

// Controller : 요청(Request)에 따라 어떤 Service를 호출 할지 "제어"하고,
...
public class ExampleController1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 서버 -> 클리아언트로 연결된 출력용 스트림 제공(PrintWriter)
		...
		// 응답 처리 2: 서버 -> 클라이언트로 연결되는 출력용 스트림 얻어오기
